...
/* This is a bad thing on node becaus the process.env: it have access to all the environment variables. One of the problem is that you can delete files with scripskk */
