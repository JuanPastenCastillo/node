...
/* 
Make an method that make the same thing of node 8.ls-advance-arguments.js but with questions on console for the user
*/
...
function askPrompt() {
  rl.question("Enter a prompt: ", (answer) => {
    ...
    // Call the function again to ask the next prompt
    askPrompt()
  })
}
